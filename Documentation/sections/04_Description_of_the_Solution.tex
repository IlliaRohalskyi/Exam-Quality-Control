...
\item This class only have a score result as percentage.
\item It interacts with Data class to receive relevant information.
\end{itemize}
...
\item Import data class to reach  special_dates_df.
